...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "The terms and conditions governing use of the Augusta Newham website and purchases.",
  path: "/terms",
});
  ...
  return (
    <>
      <JsonLd
        data={[
          ...
          pageSchema({
            ...
            path: "/terms",
            description:
              "Terms and conditions governing use of the website and purchases.",
          }),
        ]}
      />
      ...
      <LegalLayout eyebrow="Legal" title="Terms of Service">
        <h2>Overview</h2>
        <p>
          This website is operated by {site.name}. Throughout the site, the
          terms &ldquo;we&rdquo;, &ldquo;us&rdquo; and &ldquo;our&rdquo; refer to{" "}
          {site.name}. {site.name} offers this website, including all
        ...
        <p>
          ...
          <Link href="/returns-refund-shipping">Return Policy</Link>.
        </p>
        <p>
        ...
        <p>
          ...
          <Link href="/returns-refund-shipping">Returns Policy</Link>.
        </p>
        ...
        <p>
          ...
          to pay compensation for any comments; or (3) to respond to any
          comments.
        </p>
        <p>
        ...
        <p>
          ...
          our <Link href="/privacy-cookies">Privacy Policy</Link>.
        </p>
        ...
        <p>
          ...
          us) provided &lsquo;as is&rsquo; and &lsquo;as available&rsquo; for
        ...
        <p>
          In no case shall {site.name}, our directors, officers, employees,
        ...
        <p>
          You agree to indemnify, defend and hold harmless {site.name} and our
